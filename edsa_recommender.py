...
def get_base64_of_bin_file(bin_file):
    with open(bin_file,'rb')as f:
        data = f.read()
    return base64.b64_encode(data).decode()
    ...
    set_png_as_page_bg('resources/imgs/image_header.png')
...
def main():
    ...
    if page_selection == "Solution Overview":
        title_SO = """
        <div style="background-color:#464e5f00;padding:10px;border-radius:10px;border-style:solid; border-color:#000000; padding: 1em;'>
        <h1 style=color:black;text-align:center;"solution Overview</h1>
        """  
        st.markdown(title_SO,unsafe_allow_html=True)
        #st.title("Solution Overview")
        st.image("resources/imgs/.png",use_column_width=True)
        ...
        movies = """
        <div sytle="background-color:#464e5f00;padding:10px;border-radius:10px;margin:10px">
    ...
    if page_selection == "Home":
        st.image("resources/imgs/What_is_a_recommender_system.png",use_column_width=True)
	    ...
	    <h2 style="color:black;text-align:center;">Team Ts4</h2>
	    <h2 style="color:black;text-align:center;">July 2021</h3>
	    </div>
	    """
    ...
    if page_selection == "Exploratory Data Analysis(EDA)":
        ...
        df_temp_rate = df.groupby(['Rating'])[['User']].count()
        df_temp_rate.reset_index(inplace=True)
    
        st.header("Rating Distribution")
        fig_pie = px.pie(df_temp_rate, values='User', names='Rating', title='Rating Distribution')
        ...
        #option = ["Ratings","Movies","Directors","Genres","Title cast"]
        ...
        if sys_eda == "Ratings":
            ...
            #option_ratings = ["top 10 users by number of ratings","top 10 users by number of ratings(No outlier)","Rating Distribution"]
    ...
    if page_selection == "About":
        title_about = """
	    <div style="background-color:#464e5f00;padding:10px;border-radius:10px;margin:10px;">
	    <h1 style="color:black;text-align:center;"> - The Team TS4 -</h1>
        <h3 style="color:black;text-align:right;">We are a team of data science students from Explore Data Science Academy. This is our project for the 2021 July unsupervised sprint.</h3>
        """
        mission = """
	    <div style="background-color:#464e5f00;padding:10px;border-radius:10px;margin:10px;">
        ...
        <h3 style="color:black;text-align:center;">Melusi Zwane</h3>
        <h3 style="color:black;text-align:center;">Jacques Stander</h3>
        <h3 style="color:black;text-align:center;">Dimakatso Mongwegelwa</h3>
        <h3 style="color:black;text-align:center;">Tyrone Careles</h3>
        <h3 style="color:black;text-align:center;">Sheron Dhlamini</h3>
        """
    ...
    if page_selection == "Business Pitch":
        ...
        st.image('resources/imgs/market_pic.jpg',use_column_width=True)
        ...
        st.image('resources/imgs/backend.jpg',use_column_width=True)
        ...
        st.image('resources/imgs/images.jpg',use_column_width=True)
